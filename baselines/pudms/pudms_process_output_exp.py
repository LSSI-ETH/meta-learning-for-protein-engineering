    ...
    for edit_distance in [5,6,7]:
        ...
        for metaset in [0,1,2,3]:
            ...
            for trunc_factor in truncate_factor_list:
                ...
                try:
                    preds = pd.read_csv(data_path + f'ed_{edit_distance}/_test_preds_{str(trunc_factor)}_order_{str(order)}_meta_{metaset}_ed_{edit_distance}.csv')
