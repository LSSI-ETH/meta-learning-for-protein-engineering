...
results = sns.relplot(data= data, kind = 'line', x="truncate_factor", y="best_mcc",
...
fig_name_str = f'{data_type}_traditional_baselines'
...
results = sns.relplot(data= data, kind = 'line', x="truncate_factor", y="best_mcc",
                      hue='meta_set', col = "model", row = "basemodel", marker = "o", palette='nipy_spectral', 
                      legend = 'full', 
                      col_order = ['Random Forest', 'Linear SVC', 'Naive Bayes'])
...
results = sns.relplot(data= data, kind = 'line', x="truncate_factor", y="best_mcc",
                      hue='alpha', col = "model", row = "basemodel", marker = "o", palette='nipy_spectral', 
                      legend = 'full',
                      col_order = ['Random Forest', 'Linear SVC', 'Naive Bayes'])
...
results = sns.relplot(data= data, kind = 'line', x="truncate_factor", y="best_mcc",hue='meta_len', 
...
results = sns.relplot(data= data, kind = 'line', x="truncate_factor", y="best_mcc",hue='meta_set', 
                      col = "model", row = "basemodel", marker = "o", palette='plasma_r', legend = 'full',
                      col_order = ['Random Forest', 'Linear SVC', 'Naive Bayes'])
